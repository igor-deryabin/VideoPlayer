...
import com.example.player.databinding.FragmentFavoritesChannelsBinding
...
class FavoritesChannelsFragment: Fragment(), ChannelsListener {

    private var _binding: FragmentFavoritesChannelsBinding? = null
    private val binding get() = _binding!!

    private val vm: FavoritesChannelsViewModel by viewModel()
    ...
    override fun onCreateView(
        ...
        _binding = FragmentFavoritesChannelsBinding.inflate(inflater, container, false)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        vm.channels.observe(viewLifecycleOwner) { result ->
            when (result.status) {
        ...
        adapter = ChannelsAdapter(
            requireContext(),
            this@FavoritesChannelsFragment,
            emptyList()
        )
    ...
    override fun toggleFavorite(item: Channel) {
        vm.removeChannelFromFavorite(item)
    }
}